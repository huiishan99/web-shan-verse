...
ここ数日、かなり強い感覚がありました。Codex は「コードを書けるアシスタント」から、「人間が監督できるソフトウェアエンジニアリングの実行レイヤー」に近づいたのではないか、という感覚です。最初は転換点が 5 月 11 日ごろだったと思っていました。その日に `web-falling-sand` を単一の `sketch.js` からモジュール化されたプロジェクトへリファクタリングしたからです。しかし公式情報を確認すると、OpenAI が Codex のモバイル遠隔操作プレビューを発表したのは 2026-05-14 で、より大きなデスクトップ機能アップデートは 2026-04-16 に公開されていました。
...
| --- | --- | --- | --- |
| [`web-blog`](https://github.com/huiishan99/web-blog) | Astro / MDX | 2026-05-23 | この個人サイトの mobile activity map、言語メニュー、hero タイトル、ページ余白を改善 |
...
| [`cpp-tetris-game`](https://github.com/huiishan99/cpp-tetris-game) | C++ / raylib-cpp | 2026-05-23 | lock delay、DAS/ARR、SRS wall kicks、設定パネル、ローカルランキング、名前入力を追加 |
| [`python-rockfall-game`](https://github.com/huiishan99/python-rockfall-game) | Python | 2026-05-23 | 岩石バリエーション、ヘルプ画面の凡例、GUI smoke-test サンプル、学習データ向け特徴量レポートを追加 |
| [`csharp-snake-game`](https://github.com/huiishan99/csharp-snake-game) | C# | 2026-05-23 | 開始メニュー、テーマ付き controls、HUD、速度ショートカット、Windows テスト手順、release checklist を改善 |
| [`web-genAI`](https://github.com/huiishan99/web-genAI) | Python | 2026-05-23 | image generation demo を修復し、image forge interface を再設計 |
| [`web-notion-next`](https://github.com/huiishan99/web-notion-next) | Next.js / Notion | 2026-05-17 | 4.9.x user guide、テーマ文書、maintenance policy、reference manuals を整理 |
