...
Over the past few days, I have had a very strong feeling: Codex has shifted from “a coding assistant that can write code” to “a supervised execution layer for software engineering.” At first I thought the turning point was around May 11, because that was when I refactored `web-falling-sand` from a single `sketch.js` file into a modular project. After checking the official timeline, the picture became clearer: OpenAI announced the Codex mobile remote-work preview on 2026-05-14, and the broader desktop capability update had already shipped on 2026-04-16.
...
| --- | --- | --- | --- |
| [`web-blog`](https://github.com/huiishan99/web-blog) | Astro / MDX | 2026-05-23 | Fixed mobile activity map layout, language menu behavior, hero title details, and page spacing on this personal site |
...
| [`cpp-tetris-game`](https://github.com/huiishan99/cpp-tetris-game) | C++ / raylib-cpp | 2026-05-23 | Added lock delay, DAS/ARR movement, SRS wall kicks, gameplay settings, local leaderboard, and name entry |
| [`python-rockfall-game`](https://github.com/huiishan99/python-rockfall-game) | Python | 2026-05-23 | Added rock variants, help-screen legend, GUI smoke-test samples, and feature reporting for training data |
| [`csharp-snake-game`](https://github.com/huiishan99/csharp-snake-game) | C# | 2026-05-23 | Modernized the start menu, themed controls, HUD styling, speed shortcuts, Windows testing notes, and release checklist |
| [`web-genAI`](https://github.com/huiishan99/web-genAI) | Python | 2026-05-23 | Rescued the image generation demo and restyled the image forge interface |
| [`web-notion-next`](https://github.com/huiishan99/web-notion-next) | Next.js / Notion | 2026-05-17 | Consolidated 4.9.x user guides, theme documentation, maintenance policy, and reference manuals |
