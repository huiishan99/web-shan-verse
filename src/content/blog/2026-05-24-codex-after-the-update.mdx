...
过去几天我一直有一种很强烈的感觉：Codex 好像突然从“会写代码的助手”变成了“可以被监督的软件工程执行层”。我一开始以为分水岭大概是 5 月 11 日，因为那天我把 `web-falling-sand` 从一个单文件 `sketch.js` 重构成了模块化项目；后来查资料才发现，OpenAI 在 2026-05-14 正式发布了 Codex 手机端远程协作预览，而更大的桌面端能力更新则是在 2026-04-16 发布的。
...
| --- | --- | --- | --- |
| [`web-blog`](https://github.com/huiishan99/web-blog) | Astro / MDX | 2026-05-23 | 修移动端 activity map、语言菜单、hero 标题细节、页面间距，也就是这个个人网站的进一步打磨 |
...
| [`cpp-tetris-game`](https://github.com/huiishan99/cpp-tetris-game) | C++ / raylib-cpp | 2026-05-23 | 增加 lock delay、DAS/ARR、SRS wall kicks、设置面板、本地排行榜和姓名输入 |
| [`python-rockfall-game`](https://github.com/huiishan99/python-rockfall-game) | Python | 2026-05-23 | 增加不同岩石类型、帮助界面图例、GUI smoke-test 样例和训练数据特征统计 |
| [`csharp-snake-game`](https://github.com/huiishan99/csharp-snake-game) | C# | 2026-05-23 | 现代化开始菜单、主题化控件、HUD 样式、速度快捷项、Windows 测试与发布 checklist |
| [`web-genAI`](https://github.com/huiishan99/web-genAI) | Python | 2026-05-23 | 修复 image generation demo，并重新设计 image forge 界面 |
| [`web-notion-next`](https://github.com/huiishan99/web-notion-next) | Next.js / Notion | 2026-05-17 | 整理 4.9.x 用户指南、主题文档、维护流程和 reference manuals |
