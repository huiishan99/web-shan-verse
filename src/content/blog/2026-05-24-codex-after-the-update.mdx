...
| [`web-math-note`](https://github.com/huiishan99/web-math-note) | TypeScript / FastAPI | 2026-04-13 | 处理前端依赖升级，保持 Vite、Axios 等基础依赖可维护，为之后继续开发降低阻力 |

这里最让我改变看法的是 `web-falling-sand`。这类旧项目通常最大的问题不是“功能不会写”，而是当初为了快，结构没有长出来：单文件、隐式状态、没有构建脚本、没有 lint、没有测试、部署靠手感。Codex 适合处理的恰恰是这种“你知道方向，但不想手动搬砖三小时”的工程债。
