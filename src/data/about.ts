...
export const awards: AwardsItem[] = [
  ...
  },
  {
    ...
    description: {
      ...
      zh: "团队在感性设计思维工作坊中获得一等奖表彰；我也因此从20多名参与者中脱颖而出，成为4名获得 ALPS ALPINE 实习机会的人之一。",
      ja: "感性デザイン思考ワークショップでチームが一等賞として表彰され、その成果を受けて20名超の参加者のうち4名に選ばれ、ALPS ALPINE のインターンシップ機会を得ました。"
    },
